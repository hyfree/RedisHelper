...
namespace github.hyfree.RedisHelper
{
    /// <summary>
    /// Redis操作
    /// </summary>
    public class RedisAccessorHelper
    {
        ...
        public RedisAccessorHelper(int dbNum = 0)
            : this(dbNum, null)
        {
        }

        public RedisAccessorHelper(int dbNum, string readWriteHosts)
        {
            DbNum = dbNum;
        ...
        {
            string result = value is string ? value.ToString() : JsonSerializer.Serialize(value);
            return result;
        }
